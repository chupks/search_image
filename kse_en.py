...
from entermextract import TermExtractor
...
open_graph('big-graph-en.dot')
for a,b in pair_list:
    write_graph('big-graph-en.dot', a, b)
close_graph('big-graph-en.dot')
